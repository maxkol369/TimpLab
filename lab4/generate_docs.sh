#!/bin/bash
echo "=== Генерация документации для TimpLab laba4 ==="
...
if [ -f "refman.pdf" ]; then
    ...
    wkhtmltopdf --enable-local-file-access documentation/html/index.html TimpLab_laba4_documentation.pdf
fi
